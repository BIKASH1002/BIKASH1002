...
- Evaluates candidate-job match with intelligent scoring  
- Streamlit-based UI for real-time interaction  
  
🔹 **Quantum + Classical ML (Crypto Dataset)**  
- Integrated Qiskit with classical ML (SVM)  
- Worked on large-scale dataset (~600K rows)  
...
📧 Email: **bikashc.sahoo10@gmail.com**
